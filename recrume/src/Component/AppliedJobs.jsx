      ...
      return (
        <div className='mt-20 flex'>
          <div className='w-full text-center'>
            <h1 className='text-2xl font-bold mb-4'>No jobs found matching you skills or filters. Try updating 
            your skills in profile section or clear the filters.</h1>
    ...
    return (
        <div className='mt-22 flex'>
            ...
            {filteredJobs
                ...
                .map(job => (
                <Job key={job.id} job={job} isApplied={true} />
            ))}
            </div>
